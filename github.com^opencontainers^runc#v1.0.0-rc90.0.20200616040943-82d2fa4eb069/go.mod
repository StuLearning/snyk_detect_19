module github.com/opencontainers/runc-v1.0.0-rc90.0.20200616040943-82d2fa4eb069

go 1.17

require github.com/opencontainers/runc v1.0.0-rc90.0.20200616040943-82d2fa4eb069

require (
	github.com/checkpoint-restore/go-criu/v4 v4.0.2 // indirect
	github.com/cilium/ebpf v0.0.0-20200507155900-a9f01edf17e3 // indirect
