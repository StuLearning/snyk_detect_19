module github.com/opencontainers/runc-v1.0.0-rc90.0.20200624011356-1b94395c0657

go 1.17

require github.com/opencontainers/runc v1.0.0-rc90.0.20200624011356-1b94395c0657
