module github.com/opencontainers/runc-v1.0.0-rc91.0.20200804050641-f66885493801

go 1.17

require github.com/opencontainers/runc v1.0.0-rc91.0.20200804050641-f66885493801
